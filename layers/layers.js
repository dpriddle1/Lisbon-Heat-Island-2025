...
var lyr_LBN_NDVI_0 = new ol.layer.Image({
        opacity: 1,
        
    title: 'LBN_NDVI<br />\
    <img src="styles/legend/LBN_NDVI_0_0.png" /> 0.0000<br />\
    <img src="styles/legend/LBN_NDVI_0_1.png" /> 0.1300<br />\
    <img src="styles/legend/LBN_NDVI_0_2.png" /> 0.2600<br />\
    <img src="styles/legend/LBN_NDVI_0_3.png" /> 0.3900<br />\
    <img src="styles/legend/LBN_NDVI_0_4.png" /> 0.5200<br />\
    <img src="styles/legend/LBN_NDVI_0_5.png" /> 0.6500<br />\
    <img src="styles/legend/LBN_NDVI_0_6.png" /> 0.7800<br />\
    <img src="styles/legend/LBN_NDVI_0_7.png" /> 0.9000<br />\
    <img src="styles/legend/LBN_NDVI_0_8.png" /> 1.0000<br />' ,
        
        
        source: new ol.source.ImageStatic({
            url: "./layers/LBN_NDVI_0.png",
            attributions: ' ',
...
lyr_LBN_NDVI_0.setVisible(true);lyr_RVI_1.setVisible(true);lyr_TemperatureCelcius_2.setVisible(true);lyr_RGB_3.setVisible(true);lyr_OpenStreetMap_4.setVisible(true);
var layersList = [lyr_LBN_NDVI_0,lyr_RVI_1,lyr_TemperatureCelcius_2,lyr_RGB_3,lyr_OpenStreetMap_4];
